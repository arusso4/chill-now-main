...
export default function CTASection() {
  const scrollToNewsletter = () => {
    // This would scroll to a newsletter section if it exists
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        <div className="bg-gradient-to-r from-fuchsia-500/10 to-pink-500/10 backdrop-blur-sm border border-fuchsia-500/20 rounded-3xl p-12 shadow-2xl">
          ...
          <p className="text-xl text-zinc-200 mb-8 max-w-2xl mx-auto leading-relaxed">
            Get exclusive early access to limited drops, special offers, and 
            behind-the-scenes content. Join thousands of chillNOW community members.
          </p>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <div className="text-zinc-300">Drop Alerts Sent</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-white mb-2">15</div>
              <div className="text-zinc-300">Exclusive Drops</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-white mb-2">98%</div>
              <div className="text-zinc-300">Sell-Out Rate</div>
            </div>
          </div>
        </div>
      </div>
